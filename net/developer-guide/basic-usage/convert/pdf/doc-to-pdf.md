...
structuredData:
    ...
    productPlatform: net
    appName: Convert DOC to PDF in C#
    appDescription: Convert DOC to PDF natively with high performance using C# language and server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office.
    howTo:
        name: How to convert DOC to PDF in C# 
        description: Quick guide about how to convert DOC to PDF in C# with high performance and accuracy.
        url: conversion/net/convert/doc-to-pdf/#steps-to-convert-doc-to-pdf-in-c
        steps:
