...
structuredData:
    ...
    productPlatform: net
    appName: Convert DWF to PDF in C#
    appDescription: Convert DWF to PDF natively with high performance using C# language and server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office.
    howTo:
        name: How to convert DWF to PDF in C# 
        description: Quick guide about how to convert DWF to PDF in C# with high performance and accuracy.
        url: conversion/net/convert/dwf-to-pdf/#steps-to-convert-dwf-to-pdf-in-c
        steps:
