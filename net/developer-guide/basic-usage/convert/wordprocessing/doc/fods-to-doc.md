...
structuredData:
    ...
    productPlatform: net
    appName: Convert FODS to DOC in C#
    appDescription: Convert FODS to DOC natively with high performance using C# language and server side GroupDocs.Conversion for .NET APIs, without the use of any software like Microsoft or Open Office.
    howTo:
        name: How to convert FODS to DOC in C# 
        description: Quick guide about how to convert FODS to DOC in C# with high performance and accuracy.
        url: conversion/net/convert/fods-to-doc/#steps-to-convert-fods-to-doc-in-c
        steps:
